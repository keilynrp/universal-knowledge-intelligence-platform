...
ENTERPRISE_CONTROLS = (
    ...
    EnterpriseControl("ER-IR-001", "Incident response", "Detect, classify, contain, notify, and evidence security incidents.", "P0", "specified", "operated", "Security/operations owner", ("US-079",), "Close the corrective actions from the first tabletop exercise and run a second one that can establish scope.", ("First tabletop exercise held 2026-09-22 (stolen admin token): detection 6h22m and from a third party, containment 16m, containment verified to work as documented, scope reconstructible only from an isolated restore. Six gaps found; reads are not audited and the request log carries no identity, so access attribution and blast radius are not yet answerable. See docs/operating/INCIDENT_TABLETOP_2026-09-22.md.",)),
