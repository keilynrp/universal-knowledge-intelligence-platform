...
ENTERPRISE_CONTROLS = (
    ...
    EnterpriseControl("ER-IR-001", "Incident response", "Detect, classify, contain, notify, and evidence security incidents.", "P0", "identified", "operated", "Security/operations owner", ("US-079",), "Run the first tabletop exercise; the plan, severity model, declaration authority and notification workflow were approved 2026-09-22."),
