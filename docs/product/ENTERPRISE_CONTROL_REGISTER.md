...
| ER-IR-001 | Security incidents are detected, classified, contained, and evidenced | P0 | specified | operated | Security/operations owner | Corrective actions from the first exercise (2026-09-22), then a second exercise |
...
| ER-IR-001 | US-079 | Security owner | Security/operations owner | Close the remaining corrective actions from the first exercise (#375, #376, #377, #378; per-session revocation closed 2026-09-23) and run a second exercise that can establish scope | Tabletop exercise, timeline, decisions, and corrective actions |
