...
| ER-IR-001 | US-079 | Security owner | Security/operations owner | Close the corrective actions from the first exercise (#375, #376, #377, #378, #368 phase C.3) and run a second exercise that can establish scope | Tabletop exercise, timeline, decisions, and corrective actions |
