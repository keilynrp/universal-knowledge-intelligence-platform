...
![Tests](https://img.shields.io/badge/Tests-4246_collected-28A745?logo=pytest&logoColor=white)
...
<!-- BEGIN GENERATED REPOSITORY METRICS: tree-backend-tests -->
  tests/                 323 test files, 4246 tests
...
| Testing | pytest (4246 tests collected), Vitest (303 tests), Playwright |
...
**Current test stats:** 4246 backend tests collected across 323 test files. Frontend: 303 Vitest tests.
