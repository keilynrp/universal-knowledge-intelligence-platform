...
![Tests](https://img.shields.io/badge/Tests-4096_collected-28A745?logo=pytest&logoColor=white)
...
<!-- BEGIN GENERATED REPOSITORY METRICS: tree-backend-tests -->
  tests/                 316 test files, 4096 tests
...
| Testing | pytest (4096 tests collected), Vitest (289 tests), Playwright |
...
**Current test stats:** 4096 backend tests collected across 316 test files. Frontend: 289 Vitest tests.
