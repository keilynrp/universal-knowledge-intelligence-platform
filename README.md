...
![Tests](https://img.shields.io/badge/Tests-4070_collected-28A745?logo=pytest&logoColor=white)
...
<!-- BEGIN GENERATED REPOSITORY METRICS: tree-backend-tests -->
  tests/                 315 test files, 4070 tests
...
| Testing | pytest (4070 tests collected), Vitest (333 tests), Playwright |
...
**Current test stats:** 4070 backend tests collected across 315 test files. Frontend: 333 Vitest tests.
