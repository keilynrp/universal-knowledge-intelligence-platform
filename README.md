...
![Tests](https://img.shields.io/badge/Tests-4239_collected-28A745?logo=pytest&logoColor=white)
...
<!-- BEGIN GENERATED REPOSITORY METRICS: tree-backend-tests -->
  tests/                 322 test files, 4239 tests
...
| Testing | pytest (4239 tests collected), Vitest (303 tests), Playwright |
...
**Current test stats:** 4239 backend tests collected across 322 test files. Frontend: 303 Vitest tests.
