...
![Tests](https://img.shields.io/badge/Tests-4166_collected-28A745?logo=pytest&logoColor=white)
...
<!-- BEGIN GENERATED REPOSITORY METRICS: tree-backend-tests -->
  tests/                 318 test files, 4166 tests
...
| Testing | pytest (4166 tests collected), Vitest (289 tests), Playwright |
...
**Current test stats:** 4166 backend tests collected across 318 test files. Frontend: 289 Vitest tests.
