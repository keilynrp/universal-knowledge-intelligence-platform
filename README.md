...
![Tests](https://img.shields.io/badge/Tests-4122_collected-28A745?logo=pytest&logoColor=white)
...
<!-- BEGIN GENERATED REPOSITORY METRICS: tree-backend-tests -->
  tests/                 317 test files, 4122 tests
...
| Testing | pytest (4122 tests collected), Vitest (289 tests), Playwright |
...
**Current test stats:** 4122 backend tests collected across 317 test files. Frontend: 289 Vitest tests.
