...
![Tests](https://img.shields.io/badge/Tests-4195_collected-28A745?logo=pytest&logoColor=white)
...
<!-- BEGIN GENERATED REPOSITORY METRICS: tree-backend-tests -->
  tests/                 319 test files, 4195 tests
...
| Testing | pytest (4195 tests collected), Vitest (289 tests), Playwright |
...
**Current test stats:** 4195 backend tests collected across 319 test files. Frontend: 289 Vitest tests.
