...
![Tests](https://img.shields.io/badge/Tests-4198_collected-28A745?logo=pytest&logoColor=white)
...
<!-- BEGIN GENERATED REPOSITORY METRICS: tree-backend-tests -->
  tests/                 319 test files, 4198 tests
...
| Testing | pytest (4198 tests collected), Vitest (289 tests), Playwright |
...
**Current test stats:** 4198 backend tests collected across 319 test files. Frontend: 289 Vitest tests.
