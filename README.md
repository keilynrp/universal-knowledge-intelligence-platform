...
![Tests](https://img.shields.io/badge/Tests-4230_collected-28A745?logo=pytest&logoColor=white)
...
<!-- BEGIN GENERATED REPOSITORY METRICS: tree-backend-tests -->
  tests/                 321 test files, 4230 tests
...
| Testing | pytest (4230 tests collected), Vitest (303 tests), Playwright |
...
**Current test stats:** 4230 backend tests collected across 321 test files. Frontend: 303 Vitest tests.
