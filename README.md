...
![Tests](https://img.shields.io/badge/Tests-4283_collected-28A745?logo=pytest&logoColor=white)
...
<!-- BEGIN GENERATED REPOSITORY METRICS: tree-backend-tests -->
  tests/                 326 test files, 4283 tests
...
| Testing | pytest (4283 tests collected), Vitest (303 tests), Playwright |
...
**Current test stats:** 4283 backend tests collected across 326 test files. Frontend: 303 Vitest tests.
