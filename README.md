...
![Tests](https://img.shields.io/badge/Tests-4117_collected-28A745?logo=pytest&logoColor=white)
...
<!-- BEGIN GENERATED REPOSITORY METRICS: tree-backend-tests -->
  tests/                 317 test files, 4117 tests
...
| Testing | pytest (4117 tests collected), Vitest (289 tests), Playwright |
...
**Current test stats:** 4117 backend tests collected across 317 test files. Frontend: 289 Vitest tests.
