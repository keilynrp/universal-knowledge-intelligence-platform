...
![Tests](https://img.shields.io/badge/Tests-4055_collected-28A745?logo=pytest&logoColor=white)
...
<!-- BEGIN GENERATED REPOSITORY METRICS: tree-backend-tests -->
  tests/                 314 test files, 4055 tests
...
| Testing | pytest (4055 tests collected), Vitest (289 tests), Playwright |
...
**Current test stats:** 4055 backend tests collected across 314 test files. Frontend: 289 Vitest tests.
