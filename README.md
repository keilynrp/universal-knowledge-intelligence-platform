...
| Testing | pytest (4055 tests collected), Vitest (333 tests), Playwright |
...
**Current test stats:** 4055 backend tests collected across 314 test files. Frontend: 333 Vitest tests.
