...
![Tests](https://img.shields.io/badge/Tests-4102_collected-28A745?logo=pytest&logoColor=white)
...
<!-- BEGIN GENERATED REPOSITORY METRICS: tree-backend-tests -->
  tests/                 316 test files, 4102 tests
...
| Testing | pytest (4102 tests collected), Vitest (289 tests), Playwright |
...
**Current test stats:** 4102 backend tests collected across 316 test files. Frontend: 289 Vitest tests.
