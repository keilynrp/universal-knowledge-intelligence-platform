...
![Tests](https://img.shields.io/badge/Tests-4251_collected-28A745?logo=pytest&logoColor=white)
...
<!-- BEGIN GENERATED REPOSITORY METRICS: tree-backend-tests -->
  tests/                 324 test files, 4251 tests
...
| Testing | pytest (4251 tests collected), Vitest (303 tests), Playwright |
...
**Current test stats:** 4251 backend tests collected across 324 test files. Frontend: 303 Vitest tests.
