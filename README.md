...
![Tests](https://img.shields.io/badge/Tests-4290_collected-28A745?logo=pytest&logoColor=white)
...
<!-- BEGIN GENERATED REPOSITORY METRICS: tree-backend-tests -->
  tests/                 327 test files, 4290 tests
...
| Testing | pytest (4290 tests collected), Vitest (307 tests), Playwright |
...
**Current test stats:** 4290 backend tests collected across 327 test files. Frontend: 307 Vitest tests.
