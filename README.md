...
![Tests](https://img.shields.io/badge/Tests-4163_collected-28A745?logo=pytest&logoColor=white)
...
<!-- BEGIN GENERATED REPOSITORY METRICS: tree-backend-tests -->
  tests/                 318 test files, 4163 tests
...
| Testing | pytest (4163 tests collected), Vitest (289 tests), Playwright |
...
**Current test stats:** 4163 backend tests collected across 318 test files. Frontend: 289 Vitest tests.
