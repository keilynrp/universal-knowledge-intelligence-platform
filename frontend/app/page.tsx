...
export default function Home() {
  ...
  const narrativeReadinessDrivers = [
    {
      label: t("page.home.insights.readiness_source_base"),
      description: t("page.home.insights.readiness_source_base_desc"),
      percent: ingestionScore,
    },
    {
      label: t("page.home.insights.readiness_canonical_identity"),
      description: t("page.home.insights.readiness_canonical_identity_desc"),
      percent: identifierCoverageScore,
    },
    {
      label: t("page.home.insights.readiness_enrichment"),
      description: t("page.home.insights.readiness_enrichment_desc"),
      percent: enrichmentScore,
    },
    {
      label: t("page.home.insights.readiness_evidence_graph"),
      description: t("page.home.insights.readiness_evidence_graph_desc"),
      percent: graphScore,
    },
  ];
  ...
  return (
    <div className="space-y-6">
      ...
      <DashboardInsightMetrics
        ...
        readinessTitle={t("page.home.insights.readiness_title")}
        readinessSubtitle={t("page.home.insights.readiness_subtitle")}
        readinessBadge={t("page.home.insights.readiness_badge")}
        ...
        readinessDrivers={narrativeReadinessDrivers}
