...
// The world-atlas/countries-110m.json TopoJSON uses ISO numeric IDs;
// our backend produces alpha-2 codes, so we need this bridge.
// Source: ISO 3166-1 (current as of 2026).
...
export const ISO_NUM_TO_ALPHA2: Record<string, string> = {
  ...
  // Common non-ISO IDs used by world-atlas
  "-99": "OTHER",
};
