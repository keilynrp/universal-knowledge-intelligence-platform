...
const pageTitles: Record<string, { titleKey: string; subtitleKey: string; titleFallback: string; subtitleFallback: string }> = {
  ...
  "/analytics/researchers": { titleKey: "header.page.analytics_researchers.title", subtitleKey: "header.page.analytics_researchers.subtitle", titleFallback: "Researchers by Topic", subtitleFallback: "Find experts and collaboration networks from ingested records" },
