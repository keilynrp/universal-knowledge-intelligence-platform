  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        href: "/analytics/epistemic",
        icon: (
          <svg className="h-5 w-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M12 18v-5.25m0 0a6.01 6.01 0 001.5-.189m-1.5.189a6.01 6.01 0 01-1.5-.189m3.75 7.478a12.06 12.06 0 01-4.5 0m3.75 2.383a14.406 14.406 0 01-3 0M14.25 18v-.192c0-.983.658-1.823 1.508-2.316a7.5 7.5 0 10-7.517 0c.85.493 1.509 1.333 1.509 2.316V18" />
          </svg>
        ),
        translationKey: "nav.epistemic_analysis",
      },
      {
        ...
        translationKey: "nav.concept_hierarchy",
      },
      {
        label: "Domain Health",
        href: "/analytics/domain-health",
        icon: (
          <svg className="h-5 w-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M3.75 3v11.25A2.25 2.25 0 006 16.5h2.25M3.75 3h-1.5m1.5 0h16.5m0 0h1.5m-1.5 0v11.25A2.25 2.25 0 0118 16.5h-2.25m-7.5 0h7.5m-7.5 0l-1 3m8.5-3l1 3m0 0l.5 1.5m-.5-1.5h-9.5m0 0l-.5 1.5M9 11.25v1.5M12 9v3.75m3-6v6" />
          </svg>
        ),
        translationKey: "nav.domain_health",
      },
      {
        label: "Trend Topics",
      ...
      },
      {
        ...
        translationKey: "nav.coauthorship",
      },
      {
      ...
      },
      {
        ...
        translationKey: "nav.external_attention",
      },
      {
        label: "My Dashboards",
        href: "/dashboards",
      ...
      {
        label: "Retrospective",
        href: "/dashboards/retrospective",
        icon: (
          <svg className="h-5 w-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z" />
          </svg>
        ),
        translationKey: "nav.retrospective",
      },
    ],
  },
];
